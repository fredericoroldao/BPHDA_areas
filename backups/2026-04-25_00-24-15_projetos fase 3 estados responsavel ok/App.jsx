          ...
          {items.map((item) => {
            ...
            const stateKind =
              stateLabel === 'concluída'
                ...
                : stateLabel === 'em curso'
                  ? 'in_progress'
                  : stateLabel === 'à espera de dependências'
                    ? 'waiting'
                    : 'ready'
              ...
              <div key={item.id} style={{ display:'grid', gap:6 }}>
                ...
                >
                  <div style={{ display:'flex', justifyContent:'space-between', gap:8, alignItems:'flex-start' }}>
                    <div style={{ fontSize:12, color:'#16361f', lineHeight:1.35, fontWeight:600 }}>
                      {workItemTypeLabel(item.type)}: {item.name}
                    </div>
                  ...
                  {responsibleName ? (
                    <div style={{ fontSize:11, color:'#35513c', marginTop:4, lineHeight:1.35 }}>
                      Responsável: {responsibleName}
                    </div>
                  ) : null}

                  {item.description ? (
                    <div style={{ fontSize:11, color:'#5f6f66', marginTop:4, lineHeight:1.35 }}>
                      {item.description}
                    </div>
                  ) : null}

                  {hasCycle ? (
                    <div style={{ fontSize:11, color:'#8a5a12', marginTop:4, lineHeight:1.35 }}>
